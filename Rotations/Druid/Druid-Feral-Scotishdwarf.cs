    ...
    public class Feral_Scotishdwarf : CombatRoutine
    {
        ...
        public override void Pulse()
        {
            if (combatRoutine.Type == RotationType.SingleTarget)
            {
                ...
                // OPENER
                if (WoW.IsInCombat && WoW.TargetIsEnemy && WoW.IsBoss && pullwatch.ElapsedMilliseconds < 10000 && WoW.HasBossTarget)
                {
                ...
                // COOLDOWN ROTATION
                if (WoW.IsInCombat && WoW.TargetIsEnemy && WoW.HasBossTarget)
                {
