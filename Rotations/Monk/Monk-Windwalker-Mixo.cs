    ...
    public class WindwalkerMonk : CombatRoutine
    {
        ...
        public override void Pulse()
        {
            ...
            if (combatRoutine.Type == RotationType.SingleTarget)
            {
                ...
                {
                    //Touch Of Death
                    if (WoW.CanCast("TouchOfDeath") && WoW.IsSpellInRange("TigerPalm") && !GaleBurst && WoW.HasBossTarget)
                    {
                    ...
                    //SEF (Opener not done)
                    if (WoW.CanCast("SEF") && WoW.IsSpellInRange("TigerPalm") && WoW.CurrentChi >= 2 && !IsOpenerDone && !WoW.PlayerHasBuff("SEF") && !Serenity && WoW.HasBossTarget)
                    {
                        WoW.CastSpell("SEF");
                        return;
                    }
                    ...
                    if (WoW.CanCast("SEF") && WoW.IsSpellInRange("TigerPalm") && IsOpenerDone && (WoW.IsSpellOnCooldown("TouchOfDeath") || WoW.TargetHasDebuff("TouchOfDeath")) &&
                        ...
                        (!WoW.IsSpellOnCooldown("EnergizingElixir") || WoW.PlayerSpellCharges("SEF") == 2 || WoW.TargetHasDebuff("TouchOfDeath")) && WoW.HasBossTarget)
                    {
                        WoW.CastSpell("SEF");
                        return;
                    }
