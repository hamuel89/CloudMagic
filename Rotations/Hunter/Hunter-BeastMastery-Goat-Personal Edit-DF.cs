        ...
        public override void Pulse()
        {
            if (combatRoutine.Type == RotationType.SingleTarget)  // Do Single Target Stuff here
            {
                ...
                {	
                    ...
                    if (WoW.TargetIsCasting && CounterShot && interruptwatch.ElapsedMilliseconds == 0)
                    {
						...
						Log.WriteCloudMagic("interruptwatch started..", Color.Black);	
						return;
					}			
                    ...
                    if (WoW.TargetIsCasting && CounterShot && interruptwatch.ElapsedMilliseconds > 800)
                    {
                        if (WoW.CanCast("Counter Shot") && !WoW.IsSpellOnCooldown("Counter Shot") && CounterShot && !WoW.PlayerIsChanneling && !WoW.WasLastCasted("Counter Shot"))
                        {
							...
							Log.WriteCloudMagic("interruptwatch reset!", Color.Black);							
                            interruptwatch.Start();
							Log.WriteCloudMagic("interruptwatch started...", Color.Black);							
                            return;
                        }	
					...
					if (WoW.CanCast("Bestial Wrath") && WoW.Focus >= 91 && WoW.IsSpellInRange("Cobra Shot") && !WoW.PlayerHasBuff("Turtle") && !WoW.IsSpellOnCooldown("Bestial Wrath") && !WoW.IsSpellOnCooldown("Kill Command"))
                    {
                        WoW.CastSpell("Bestial Wrath");
                        return;
                    }
					...
					//{
						...
						//return;
					//}
					if (WoW.CanCast("Kill Command") && WoW.Focus >= 94 && WoW.IsSpellInRange("Kill Command") && !(WoW.SpellCooldownTimeRemaining("Bestial Wrath") <= 1))
                    {
					...
					if (WoW.CanCast("Kill Command") && WoW.Focus >= 25 && WoW.IsSpellInRange("Kill Command") && WoW.PlayerHasBuff("Bestial Wrath"))
                    {
                        WoW.CastSpell("Kill Command");
                        return;
                    }
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 34) && WoW.IsSpellInRange("Cobra Shot") && WoW.PlayerHasBuff("Bestial Wrath") && (WoW.SpellCooldownTimeRemaining("Kill Command") >= 3))
                    {
					...
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 103) && WoW.IsSpellInRange("Cobra Shot") && WoW.SpellCooldownTimeRemaining("Bestial Wrath") < WoW.SpellCooldownTimeRemaining("Kill Command") && WoW.SpellCooldownTimeRemaining("Kill Command") >= 1)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
            ...
            if (combatRoutine.Type == RotationType.AOE)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat)
                {
                    ...
                    if (WoW.CanCast("Kill Command") && WoW.Focus >= 55 && WoW.IsSpellInRange("Kill Command") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") >= 1 && !(DetectKeyPress.GetKeyState(0x5A) < 0) && !FourTarget  && !(WoW.SpellCooldownTimeRemaining("Bestial Wrath") <= 2))
                    {
                        WoW.CastSpell("Kill Command");
                        return;
                    }
            ...
            if (combatRoutine.Type == RotationType.SingleTargetCleave)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat)
                {
                    ...
                    if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat && multishotwatch.ElapsedMilliseconds == 0)
                    {
                        ...
                        Log.WriteCloudMagic("multishotwatch started..", Color.Black);
                        return;
                    }
