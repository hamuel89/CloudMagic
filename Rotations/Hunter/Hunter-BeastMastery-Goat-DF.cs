        ...
        public override void Pulse()
        {
            if (combatRoutine.Type == RotationType.SingleTarget)  // Do Single Target Stuff here
            {
                ...
                {	
					...
					if (WoW.CanCast("Kill Command") && WoW.Focus >= 80 && WoW.IsSpellInRange("Kill Command") && !(WoW.SpellCooldownTimeRemaining("Bestial Wrath") <= 100))
                    {
					...
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 81) && WoW.IsSpellInRange("Cobra Shot") && WoW.SpellCooldownTimeRemaining("Kill Command") >= 200)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 105) && WoW.IsSpellInRange("Cobra Shot") && WoW.SpellCooldownTimeRemaining("Bestial Wrath") < WoW.SpellCooldownTimeRemaining("Kill Command") && WoW.SpellCooldownTimeRemaining("Kill Command") >= 100)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
