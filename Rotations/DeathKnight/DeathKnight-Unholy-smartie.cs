    ...
    public class DKUnholysmartie : CombatRoutine
    {
        ...
        public override void Pulse()
        {
            ...
            if (DetectKeyPress.GetKeyState(cooldownKey) < 0 && (cooldownModifier == -1 || cooldownModifier != -1 && DetectKeyPress.GetKeyState(cooldownModifier) < 0))
            {
                ...
                {
                    combatRoutine.WoW.HasBossTarget = !combatRoutine.WoW.HasBossTarget;
                    coolDownStopWatch.Restart();
                }
            }
            ...
            if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat && WoW.TargetIsVisible && !WoW.IsMounted)
            {
				...
				if (combatRoutine.Type == RotationType.SingleTarget || combatRoutine.Type == RotationType.SingleTargetCleave) // Do Single Target Stuff here
				{
					...
					{
						//Cooldowns
						if (combatRoutine.WoW.HasBossTarget && !WoW.ItemOnCooldown("KBW") && isCheckHotkeyslegytrinket)
						{
							WoW.CastSpell("KBW") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && !isCheckHotkeyslegyshoulder && isCheckHotkeysUnholyOffensiveSummonGargoyle && WoW.CanCast("Summon Gargoyle") && WoW.CurrentRunes >= 3 && WoW.Talent(7) != 1)
						{
							WoW.CastSpell("Summon Gargoyle") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && isCheckHotkeysUnholyOffensiveSummonGargoyle && WoW.CanCast("Summon Gargoyle") && WoW.CurrentRunes >= 3 && WoW.SpellCooldownTimeRemaining("Dark Transformation") >= 1000 && WoW.Talent(7) != 1)
						{
							WoW.CastSpell("Summon Gargoyle") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.CanCast("Dark Arbiter") && !isCheckHotkeyslegyshoulder && WoW.RunicPower <=70 && WoW.Talent(7) == 1)
						{
							WoW.CastSpell("Dark Arbiter") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.CanCast("Dark Arbiter") && isCheckHotkeyslegyshoulder && WoW.RunicPower <=70 && WoW.Talent(7) == 1 && WoW.SpellCooldownTimeRemaining("Dark Transformation") >= 200)
						{
							WoW.CastSpell("Dark Arbiter") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && !isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.CurrentRunes >= 3)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.Talent(7) == 1 && WoW.SpellCooldownTimeRemaining("Dark Arbiter") >= 16500)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.Talent(7) == 1 && WoW.Talent(6) != 1 && WoW.SpellCooldownTimeRemaining("Dark Arbiter") >= 5500)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.Talent(7) == 1 && WoW.Talent(6) == 1 && WoW.SpellCooldownTimeRemaining("Dark Arbiter") >= 3500)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.Talent(7) == 1 && WoW.Talent(6) != 1 && WoW.SpellCooldownTimeRemaining("Summon Gargoyle") >= 5500)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && isCheckHotkeyslegyshoulder && WoW.CanCast("Dark Transformation") && WoW.Talent(7) == 1 && WoW.Talent(6) == 1 && WoW.SpellCooldownTimeRemaining("Summon Gargoyle") >= 3500)
						{
							WoW.CastSpell("Dark Transformation") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.CanCast("Soul Reaper") && WoW.Talent(7) == 3 && WoW.TargetDebuffStacks("Festering Wound") >=6 && WoW.SpellCooldownTimeRemaining("Apocalypse") >= 400 && WoW.CurrentRunes >= 1)
						{
							WoW.CastSpell("Soul Reaper") ;
							return;
						}
						if (combatRoutine.WoW.HasBossTarget && WoW.CanCast("Apocalypse") && WoW.TargetDebuffStacks("Festering Wound") >=6)
						{
						...
						if (!combatRoutine.WoW.HasBossTarget && WoW.TargetHasDebuff("Virulent Plague") && WoW.CanCast("Soul Reaper") &&  WoW.Talent(7) == 3 && WoW.TargetDebuffStacks("Festering Wound") >=3 && WoW.CurrentRunes >= 1)
						{
							WoW.CastSpell("Soul Reaper") ;
							return;
						}
