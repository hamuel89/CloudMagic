...
namespace CloudMagic.Rotation
{
    public class DKFrostMGFmflex : CombatRoutine
    {
        ...
        public void BreathRotation()
        {
            ...
            if (combatRoutine.WoW.HasBossTarget && isCheckHotkeysFrostOffensivePillarofFrost && !WoW.IsSpellOnCooldown("PillarofFrost") && hasBreath && WoW.Level >= 57)
            {
                WoW.CastSpell("PillarofFrost");
            }
            if (combatRoutine.WoW.HasBossTarget && isCheckHotkeysFrostOffensivePillarofFrost && !WoW.IsSpellOnCooldown("PillarofFrost") && !hasBreath && WoW.SpellCooldownTimeRemaining("Breath") >= 5900 && WoW.Level >= 57)
            {
                WoW.CastSpell("PillarofFrost");
            }
            if ((haveCoF || useNextHRWCharge) && isCheckHotkeyslegyring && haveHRW && runicPower <= 30 && isCheckHotkeysFrostOffensiveErW && combatRoutine.WoW.HasBossTarget && !WoW.PlayerHasBuff("HEmpower Rune") && !WoW.IsSpellOnCooldown("HEmpower Rune") && hasBreath && legyringtest == true && WoW.Level >= 58)
            {
                useNextHRWCharge = false;
                WoW.CastSpell("HEmpower Rune");
				legyringtest = false;
            }
            if ((haveCoF || useNextHRWCharge) && !isCheckHotkeyslegyring && haveHRW && runicPower <= 30 && isCheckHotkeysFrostOffensiveErW && combatRoutine.WoW.HasBossTarget && !WoW.PlayerHasBuff("HEmpower Rune") && !WoW.IsSpellOnCooldown("HEmpower Rune") && hasBreath && WoW.Level >= 58)
            {
                useNextHRWCharge = false;
                WoW.CastSpell("HEmpower Rune");
            }
            ...
            if ((haveCoF || useNextHRWCharge) && !haveHRW && runicPower <= 50 && currentRunes <=1 && isCheckHotkeysFrostOffensiveErW && combatRoutine.WoW.HasBossTarget && !WoW.IsSpellOnCooldown("HEmpower Rune") && hasBreath && WoW.Level >= 57)
            {
                WoW.CastSpell("Empower Rune");
            }
            if (combatRoutine.WoW.HasBossTarget && isMelee && currentRunes >= 2 && runicPower >= 70 && CanCastNoRange("Breath") && WoW.Level >= 100)
            {
                WoW.CastSpell("Breath");
                useNextHRWCharge = true;
                return;
            }
            if (combatRoutine.WoW.HasBossTarget && isMelee && runicPower >= 70 && CanCastNoRange("Breath"))
            {
                return;
            }
            ...
            if (isMelee && currentRunes >= 1 && WoW.Level >= 57 && ((runicPower >= 48 && hasBreath) || !hasBreath) && (!combatRoutine.WoW.HasBossTarget || (combatRoutine.WoW.HasBossTarget && WoW.SpellCooldownTimeRemaining("Breath") >= 1500)) && CanCastNoRange("Remorseless Winter"))
            {
            ...
            if (runicPower >= 25 && CanCastInRange("Frost Strike") && !hasBreath && (!combatRoutine.WoW.HasBossTarget || (combatRoutine.WoW.HasBossTarget && WoW.SpellCooldownTimeRemaining("Breath") >= 1500)))
            {
                WoW.CastSpell("Frost Strike");
                return;
            }
        ...
        {
            if (isCheckHotkeysFrostOffensivePillarofFrost && isMelee && combatRoutine.WoW.HasBossTarget && !WoW.IsSpellOnCooldown("PillarofFrost") && WoW.Level >= 57)
            {
                WoW.CastSpell("PillarofFrost");
            }
            if (combatRoutine.WoW.HasBossTarget && isCheckHotkeysFrostOffensiveErW && isMelee && currentRunes == 0 && WoW.PlayerHasBuff("PillarofFrost") && !WoW.IsSpellOnCooldown("Empower Rune") && WoW.Level >= 57)
            {
                WoW.CastSpell("Empower Rune");
            }
            if (combatRoutine.Type == RotationType.SingleTarget || combatRoutine.Type == RotationType.SingleTargetCleave) // Do Single Target Stuff here
            {
                if (CanCastInRange("Frost Strike") && (!WoW.PlayerHasBuff("Icy Talons") || WoW.PlayerBuffTimeRemaining("Icy Talons") <= 200) && runicPower >= 25 &&
                    !(combatRoutine.WoW.HasBossTarget && CanCastNoRange("Obliteration") && WoW.Talent(7) == 1) &&
                ...
                if (combatRoutine.WoW.HasBossTarget && isMelee && currentRunes >= 2 && runicPower >= 25 && WoW.Talent(7) == 1 && CanCastNoRange("Obliteration") && WoW.Level >= 100)
                {
                ...
                if (WoW.Talent(7) == 1 && runicPower >= 40 && CanCastInRange("Frost Strike") && !(combatRoutine.WoW.HasBossTarget && CanCastNoRange("Obliteration")) && WoW.Talent(7) == 1 &&
