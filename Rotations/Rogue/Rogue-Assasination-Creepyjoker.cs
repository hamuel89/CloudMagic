            ...
            if (combatRoutine.Type == RotationType.SingleTarget)
            {
				...
				
				{
					...
					if (WoW.CanCast("Mutilate") && WoW.Energy >= 55 && WoW.CurrentComboPoints <= 3 )
					{
 					...
 					if (WoW.HasBossTarget && WoW.CanCast("Vendetta") &&
					...
					if (!WoW.PlayerHasBuff("Critbuff") && WoW.HasBossTarget && WoW.CurrentComboPoints == 5 && !WoW.IsSpellOnCooldown("Vanish") && WoW.Energy >= 35 && WoW.TargetHasDebuff("Vendetta") )
					{
						WoW.CastSpell("Vanish");
						return;
					}
					if (WoW.HasBossTarget && WoW.CurrentComboPoints == 5 && WoW.PlayerHasBuff("Vanish") && WoW.Energy >= 35 && WoW.TargetHasDebuff("Vendetta"))
					{
						WoW.CastSpell("Rupture");
						return;
					}
