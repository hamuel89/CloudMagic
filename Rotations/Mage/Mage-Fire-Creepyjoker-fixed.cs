        ...
        public override void Pulse()
        {
            ...
            }
            {
                ...
                if (combatRoutine.Type == RotationType.SingleTarget)
                    ...
                    {
                        if (WoW.HasBossTarget && RuneOfPower && WoW.PlayerSpellCharges("Rune of Power") >= 1 && WoW.SpellCooldownTimeRemaining("Combustion") >= 40 &&
                            ...
                            (WoW.HasBossTarget && RuneOfPower && !WoW.PlayerIsCasting && WoW.PlayerSpellCharges("Fire Blast") == 3 && WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 &&
                        ...
                        if (WoW.HasBossTarget && Mirrors && WoW.CanCast("Mirror Image") && !WoW.IsSpellOnCooldown("Mirror Image") && WoW.PlayerHasBuff("Combustion"))
                        {
                        ...
                        if (WoW.CanCast("Phoenix's Flames") && !WoW.PlayerHasBuff("Hot Streak!") && WoW.IsSpellOnCooldown("Fire Blast") && WoW.SpellCooldownTimeRemaining("Fire Blast") > 1.1 &&
                            WoW.PlayerHasBuff("Heating Up") && WoW.HasBossTarget && Combustion && WoW.PlayerSpellCharges("Phoenix's Flames") == 3 && !WoW.IsSpellOnCooldown("Combustion"))
                        {
                            WoW.CastSpell("Phoenix's Flames");
                            return;
                        }
                        if (WoW.PlayerIsCasting && WoW.HasBossTarget && WoW.PlayerHasBuff("Heating Up") && Combustion && WoW.PlayerSpellCharges("Phoenix's Flames") == 3 &&
                        ...
                        if (WoW.CanCast("Phoenix's Flames") && !WoW.PlayerHasBuff("Hot Streak!") && WoW.PlayerHasBuff("Heating Up") && WoW.LastSpell != "Fire Blast" &&
                            WoW.LastSpell != "Phoenix's Flames" && WoW.IsSpellOnCooldown("Fire Blast") && WoW.SpellCooldownTimeRemaining("Fire Blast") > 1.1 && !WoW.HasBossTarget && Combustion &&
                            WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 && !WoW.IsSpellOnCooldown("Combustion"))
                        {
                            WoW.CastSpell("Phoenix's Flames");
                            return;
                        }
                        if (!WoW.HasBossTarget && Combustion && WoW.PlayerIsCasting && WoW.LastSpell != "Phoenix's Flame" && WoW.LastSpell != "Fire Blast" && WoW.PlayerHasBuff("Heating Up") &&
                        ...
                        if (!WoW.HasBossTarget && WoW.CanCast("Cinderstorm") && Cinderstorm && WoW.TargetHasDebuff("Ignite") && !WoW.PlayerHasBuff("Combustion") && !WoW.PlayerHasBuff("Hot Streak!"))
                        {
                            WoW.CastSpell("Cinderstorm");
                            return;
                        }
                        if (WoW.HasBossTarget && WoW.CanCast("Cinderstorm") && Cinderstorm && WoW.TargetHasDebuff("Ignite") && !WoW.PlayerHasBuff("Combustion") &&
                            WoW.IsSpellOnCooldown("Combustion") && WoW.SpellCooldownTimeRemaining("Combustion") > 5 && !WoW.PlayerHasBuff("Hot Streak!"))
                        {
                            WoW.CastSpell("Cinderstorm");
                            return;
                        }
                        if (WoW.HasBossTarget && Combustion && !WoW.IsSpellOnCooldown("Combustion") && WoW.PlayerHasBuff("Rune of Power") && WoW.PlayerSpellCharges("Fire Blast") == 3 &&
                            WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 && !WoW.PlayerIsCasting && !WoW.PlayerIsChanneling ||
                            WoW.HasBossTarget && Combustion && Mirrors && WoW.PlayerSpellCharges("Fire Blast") == 3 && WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 &&
                        ...
                        if (WoW.CanCast("Pyroblast") && !WoW.HasBossTarget && Combustion && WoW.PlayerHasBuff("Hot Streak!"))
                        {
                            WoW.CastSpell("Pyroblast");
                            return;
                        }
            ...
            {
                if (WoW.HasBossTarget && RuneOfPower && WoW.PlayerSpellCharges("Rune of Power") >= 1 && WoW.SpellCooldownTimeRemaining("Combustion") >= 40 && WoW.PlayerHasBuff("Hot Streak!") &&
                    !WoW.PlayerIsCasting && !WoW.IsMoving && !WoW.PlayerHasBuff("Rune of Power") && !WoW.IsSpellOnCooldown("Rune of Power") ||
                    (WoW.HasBossTarget && RuneOfPower && !WoW.PlayerIsCasting && WoW.PlayerSpellCharges("Fire Blast") == 3 && WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 && !WoW.IsMoving &&
                ...
                if (WoW.HasBossTarget && WoW.CanCast("Cinderstorm") && Cinderstorm && WoW.TargetHasDebuff("Ignite") && !WoW.PlayerHasBuff("Combustion") && WoW.IsSpellOnCooldown("Combustion") &&
                ...
                if (WoW.HasBossTarget && Combustion && !WoW.IsSpellOnCooldown("Combustion") && WoW.PlayerHasBuff("Rune of Power") && WoW.PlayerSpellCharges("Fire Blast") == 3 &&
                    WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 && !WoW.PlayerIsCasting && !WoW.PlayerIsChanneling ||
                    WoW.HasBossTarget && Combustion && Mirrors && WoW.PlayerSpellCharges("Fire Blast") == 3 && WoW.PlayerSpellCharges("Phoenix's Flames") >= 2 && WoW.PlayerHasBuff("Hot Streak!") &&
                ...
                if (!WoW.PlayerIsCasting && WoW.CanCast("Flamestrike") && !WoW.HasBossTarget && Combustion && WoW.PlayerHasBuff("Hot Streak!"))
                {
                    WoW.CastSpell("Flamestrike");
                    return;
                }
